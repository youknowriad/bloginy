...
class ArGlyphs
{
     ...
     * @return string
     */                                  
    private function _getGlyphs($char, $type)
    {
     ...
     * @author Khaled Al-Shamaa <khaled.alshamaa@gmail.com>
     */
    private function _preConvert($str)
    {
        $crntChar = null;
        $prevChar = null;
        $nextChar = null;
     ...
     * @return string           
     */
    private function _decodeEntities($text, $exclude = array())
    {
        static $table;
     ...
     * @return string                  
     */
    private function _decodeEntities2($prefix, $codepoint, $original, &$table, &$exclude)
    {
        // Named entity
        if (!$prefix) {
